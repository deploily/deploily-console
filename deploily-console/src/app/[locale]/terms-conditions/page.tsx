...
export const metadata: Metadata = {
  ...
  description:
    "Read Deploily's terms of service, including account usage, billing, service limitations, termination, and liability.",
  keywords:
    "Terms and Conditions, Cloud Service Terms, Billing, User Agreement, SLA, Legal, Deploily Policy",
