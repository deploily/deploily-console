            ...
            {!isLoading && hiEventsAppById !== undefined &&
                <>
                    <Row gutter={16}  >
                        <Col md={16} xs={24} >
                            <Badge offset={[-20, 20]}>
                                {hiEventsAppById.service_details && <ImageFetcher
                        ...
                        <Col md={8} xs={24}>
                            ...
                            <Row>
                                ...
                                <DocumentationComponents hiEventsAppById={hiEventsAppById} setOpenDrawer={setOpenDrawer} />
                            </Row>
                        </Col>
                    </Row>
                    ...
                    <DocumentationDrawer openDrawer={openDrawer} onClose={onClose} currentSubscription={hiEventsAppById} t={t} />
