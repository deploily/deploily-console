...
} from "@/lib/features/my-applications/myApplicationSlice";
...
export default function UpgradeMyAppSubscriptionComponents({
  ...
  const handleContactUs = () => {
    ...
    dispatch(
      postFeedBack(
        `${translate("interstedCustomPlan")} ${app_service_plan?.service.name} :  ${comment}`,
      ),
    );
    setComment("");
  };
  ...
  return (
    <>
      ...
      >
        {!servicePlanLoading &&
          servicePlanResponse?.result &&
          servicePlanResponse?.result !== undefined && (
            <HomeCarousel>
                ...
                return (
                  ...
                  >
                    <PlanCard
                      ...
                      styles={{
                        color:
                          app_service_plan != undefined && app_service_plan.id == plan.id
                      ...
                      customPlanSelected={
                        app_service_plan != undefined && app_service_plan.is_custom
                      }
                      showModal={showModal}
                    />
                  </div>
