                ...
                <Row align="middle" gutter={16} style={{ height: "40%" }} >
                    ...
                    <Col span={12}
                        ...
                        <Paragraph style={{ color: "#DD8859", fontSize: 16, }}>
                            {Intl.NumberFormat('fr-FR', { useGrouping: true }).format(data.total_amount / data.duration_month)} DZD / {data.service_plan.subscription_category === "monthly" ? t("month") : t("year")}
