...
export default function MyAppPaymentDrawer({
  serviceId,
  openDrawer,
  onClose,
  subscriptionOldId,
  ...
  const {
    ...
    selectedProfile,
    isBalanceSufficient,
  } = useUpgradeRenewMyApplicationDataState();
  ...
  useEffect(() => {
    dispatch(
      updateUpgradeRenewMyAppState({selected_version: applicationServiceById?.app_versions[0]}),
    );
  ...
  const handleChangeVersion = (value: number) => {
    dispatch(
      updateUpgradeRenewMyAppState({
        selected_version: applicationServiceById?.app_versions?.find(
        ...
        <Col style={{padding: 20}}>
          ...
          >
            {[
              ...
              },
              {
                ...
                value: (
                  ...
                  >
                    <Select
                      defaultValue={
                        typeof selected_version?.id === "number" ? selected_version.id : undefined
                      }
                      style={{width: 150, borderRadius: "10px"}}
              ...
              <Row gutter={16} align="top" style={{marginBottom: index === 8 ? 0 : 12}} key={index}>
                <Col span={14}>
            ...
            <div style={{padding: "5px 0px"}}>
              {isBalanceSufficient === true ? (
                <IsBalanceSufficientComponent
                  onClose={onClose}
                  handleSubscribe={() => handleUpgradeSubscribe()}
                />
