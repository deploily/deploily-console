                            ...
                            <Row>
                                <Col span={24} style={{
                                    ...
                                    <Typography.Title level={2} style={{ color: theme.token.orange400 }}>
                                        {Intl.NumberFormat('fr-FR', { useGrouping: true }).format(supabaseAppById.total_amount / supabaseAppById.duration_month)} DZD / {supabaseAppById.service_plan.subscription_category === "monthly" ? t("month") : t("year")}
