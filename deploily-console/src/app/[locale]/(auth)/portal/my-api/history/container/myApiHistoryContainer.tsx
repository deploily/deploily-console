...
export default function MyApiHistoryContainerr() {
  ...
  const {subscriptionHistoryLoading, subscriptionHistoryList, subscriptionHistoryLoadingError} =
    useSubscriptionHistoryList();
  const t = useI18n();
    ...
    return [
      {
        ...
        render: (image: string | null | undefined) =>
          image ? <ImageFetcher imagePath={image} width={40} height={40} /> : "-",
      },
      {
        title: tHistory("name"),
