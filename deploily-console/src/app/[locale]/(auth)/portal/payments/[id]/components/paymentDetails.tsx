...
export default function PaymentDetailsPage({paymentId}: {paymentId: string}) {
  ...
  const {currentPayment, currentPaymentLoading, currentPaymentLoadingError, uploadSuccess} =
    usePayment();
          ...
          <>
            {currentPayment?.payment_method == "bank_transfer" && (
              ...
              >
                ...
                ) : currentPayment.payment_receipt !== undefined &&
                  currentPayment.payment_receipt !== null ? (
                  <ImageFetcher
                ...
                {!file ? (
                  <Upload beforeUpload={handleFileChange} showUploadList={false} accept="image/*">
