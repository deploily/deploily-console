...
export default function ApplicationDetailsPageContent({applicationId}: {applicationId: any}) {
  ...
  const {totalAmount, duration, selected_version, app_service_plan, managed_ressource_details} =
    useNewApplicationSubscription();
  ...
  useEffect(() => {
    if (managed_ressource_details?.isManaged) {
      dispatch(
        updateNewAppSubscriptionState({duration: managed_ressource_details?.time_remaining}),
      );
    }
      ...
      >
        ...
        <Row gutter={[24, 24]} wrap style={{justifyContent: "center", margin: "0px"}}>
          ...
          <Col xs={24} md={24} lg={16} style={{padding: "0px", margin: "0px"}}>
            ...
            {!screens.lg &&
              !applicationServiceById.is_subscribed &&
              app_service_plan &&
              !app_service_plan.is_custom && (
                <div
                  style={{
            ...
            <div style={{padding: "8px 0"}}>
              <ApplicationDetailsCollapseContainer
                ...
                specifications={applicationServiceById.specifications}
