...
export default function AddPaymentProfile() {
  ...
  const handleFinish = async (values: any) => {
    ...
    await dispatch(
      postPaymentProfile({...payload, profile_type: isCompany ? "company" : "personal"}),
    ).then((result) => {
  ...
  return (
    <div style={{paddingInline: 10}}>
      ...
      >
        <Form.Item>
          <Radio.Group onChange={(e) => setIsCompany(e.target.value)} value={isCompany}>
        ...
        {isCompany ? (
          <>
            ...
            <Row gutter={16}>
              <Col md={12} xs={24}>
                <Form.Item
                  label={renderLabel(t("commercialRegister"))}
        ...
        <div
          style={{display: "flex", justifyContent: "flex-end", marginTop: 20, paddingBottom: 40}}
        >
