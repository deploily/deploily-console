        ...
        <Row align="top" justify="space-between" gutter={16} style={{height: "40%"}}>
          <Col span={12}>
            <Badge
              ...
              offset={[-12, 12]}
            >
              <ImageFetcher imagePath={resource.image_service} width={100} height={100} />
            </Badge>
          </Col>
          ...
          >
            <Paragraph style={{color: "#DD8859", fontSize: 16}}>
              {resource.unit_price !== undefined
                ? Intl.NumberFormat("fr-FR", {useGrouping: true}).format(resource.unit_price) +
                  " DZD " +
                  " / " +
                  (resource.price_category == "monthly" ? t("month") : t("year"))
