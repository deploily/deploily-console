...
import {
  ...
  getProvidersList,
} from "@/lib/features/cloud-resource/cloudResourceThunks";
          ...
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={12} md={12} lg={7}>
              <Select
                ...
                options={
                  resourceCategoriesResponse &&
                  resourceCategoriesResponse.result.map((provider) => ({
                    value: provider.id,
                    label: provider.name,
                  }))
                }
            ...
            <Col xs={24} sm={12} md={12} lg={7}>
              <Select
                ...
                options={
                  providersListResponse &&
                  providersListResponse.result.map((provider) => ({
                    value: provider.id,
                    label: provider.name,
                  }))
                }
