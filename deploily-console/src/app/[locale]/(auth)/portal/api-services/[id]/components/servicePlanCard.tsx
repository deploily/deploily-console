...
export default function ServicePlanCard({
  ...
  return (
    <Card
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.borderColor = !currentService?.is_subscribed
          ? theme.token.orange600
          : "none";
        e.currentTarget.style.boxShadow = !currentService?.is_subscribed
          ? `4px 4px 10px 0px ${theme.token.orange600}`
          : "none";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      >
        ...
        <span style={{fontSize: 16, fontWeight: 400}}>
          {" "}
          DZD/
          {servicePlan!.subscription_category === "yearly" ? t("year") : t("month")}
        </span>
      </Typography.Paragraph>
