export interface MobileApplicationDataUpdatedState {
  mobileApplicationUpdated?: any;
  isLoading: boolean;
  loadingError?: any;
}


export interface MobileApplicationByIdState {
  mobileApplicationById?: mobileApplicationDepInterface;
  isLoading: boolean;
  loadingError?: any;
}
export interface MobileApplicationDeptResponse {
  result: mobileApplicationDepInterface[];
}
export interface mobileApplicationDepInterface {
  access_url: string;
  api_key: string;
  argocd_url: string;
