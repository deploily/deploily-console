        ...
        result: [
            {
                ...
                is_subscribed: false,
                short_description: "Docker is a platform designed to help developers build, share, and run modern applications.",
                unit_price: 1000,
                documentation_url: "https://docs.docker.com/get-started/",
                created_at: "2023-10-10T12:00:00Z",
                updated_at: "2023-10-15T12:00:00Z",
                deployment_versions: [
                    { id: 1, name: "v20.10.7", description: "Stable release with performance improvements and bug fixes." },
                ],
                specifications: "- Containerization platform\n- Supports Windows, Mac, and Linux\n- Easy to use GUI\n- Command-line interface\n- Integration with CI/CD tools\n- Extensive documentation and community support"
